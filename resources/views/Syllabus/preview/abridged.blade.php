...
<body>
    ...
    <div id="syllabus-content" style="display:none;">
        ...
        ════════════════════════════════════════════════════════════════════ --}}
        <div
            style="display:grid; grid-template-columns:80px 1fr 80px;
            ...
            <div style="display:flex; justify-content:flex-start;">
                <img src="{{ !empty($isSnapshot) && !empty($inlineLogoDataUri) ? $inlineLogoDataUri : asset('assets/clsu-logo-green.png') }}"
                    alt="CLSU Logo" style="width:120px; height:auto; margin-left:70px;" />
            </div>
        ...
        <div class="a4-section"
            style="font-style:italic; font-size:9pt; color:#444; line-height:1.5; border:1px solid #ccc; padding:8px 12px;">
        ...
        ════════════════════════════════════════════════════════════════════ --}}
        <div class="a4-section">
            <h3 class="abridged-indent title-numbered" style="font-size:11pt; margin-bottom:6px;">
        ...
        <div class="a4-section">
            ...
            @if ($syllabus->course->has_lec_lab)
                <p class="abridged-indent" style="margin:0 0 4px; font-size:9pt;"><strong>Lecture (LEC)</strong></p>
            @endif
            ...
            @if ($syllabus->course->has_lec_lab)
                <p class="abridged-indent" style="margin:10px 0 4px; font-size:9pt;"><strong>Laboratory (LAB)</strong>
                </p>
        ...
        <div class="a4-section">
            ...
            <table border="1" style="width:100%; border-collapse:collapse;">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ $syllabus->course->has_lec_lab ? 6 : 4 }}" style="text-align:center;">No
                                evaluation items found.</td>
                        </tr>
                    @endforelse
            ...
            <div class="abridged-indent">
                <p style="margin-top:8px;"><strong>Minimum Average for Satisfactory Performance:
            ...
            <p class="indent-level-2" style="margin-top:4px;"><strong>Passing Mark:
                    {{ $lecPassMark ?? 60 }}%</strong></p>
        </div>

        {{-- ═══════════════════════════════════════════════════════════════════
             SECTION V — REQUIRED READING MATERIALS
        ════════════════════════════════════════════════════════════════════ --}}
        <div class="abridged-indent a4-section">
        ...
        {{-- ═══════════════════════════════════════════════════════════════════
             PREPARED BY
        ════════════════════════════════════════════════════════════════════ --}}
        <div class="abridged-indent a4-section" style="margin-top:24px;">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function canSplit(el) {
                return el.nodeType === Node.ELEMENT_NODE && ["DIV", "UL", "OL", "LI", "SECTION"].includes(el
                        .tagName) &&
                            ...
                            Array.from(row.cells).forEach(cell => {
                                ...
                                for (let i = 0; i < cs; i++) {
                                    if (ci + i < totalCols) {
                                        ...
                                        if (rs > 1) occupied[ci + i] = Math.max(occupied[ci + i],
                                            rs - 1);
                                    }
                                }
                                ci += cs;
