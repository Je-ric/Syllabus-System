...
<x-accordion title="Week Types" icon="info-circle" color="blue">
    <div class="space-y-2 text-[13px] text-[#3f3f46]">
        <div class="flex items-start gap-2.5 p-2 rounded-lg bg-[#f0fdf4] border border-[#d1fae5]">
            ...
            <div><p class="font-semibold text-[#166534]">Week 1 — MVGO</p><p class="text-[12px] mt-0.5">Always Mission-Vision-Goals-Objectives. The CO selector is replaced by an MVGO badge and cannot be changed.</p></div>
        </div>
        <div class="flex items-start gap-2.5 p-2 rounded-lg bg-[#fffbeb] border border-[#fde68a]">
            ...
            <div><p class="font-semibold text-[#92400e]">Exam / Non-Teaching Weeks</p><p class="text-[12px] mt-0.5">Locked automatically from calendar events. Content is auto-filled and cannot be edited.</p></div>
        </div>
        <div class="flex items-start gap-2.5 p-2 rounded-lg bg-white border border-[#e4e4e7]">
            ...
            <div><p class="font-semibold text-[#09090b]">Regular Weeks</p><p class="text-[12px] mt-0.5">Fully editable. Fill in topic, activities, assessment task, and CO mappings.</p></div>
        </div>
    </div>
</x-accordion>
...
<x-accordion title="Filling in a Week" icon="list-ol" color="slate">
    ...
    <p class="mt-2 text-[12px] text-[#71717a]">If the course has both LEC and LAB, use the tab switcher to fill in each component separately.</p>
</x-accordion>
