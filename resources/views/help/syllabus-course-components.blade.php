...
<x-accordion title="LEC Component" icon="book-open" color="emerald">
...
<x-accordion title="LAB Component" icon="test-tube" color="blue">
    <div class="space-y-2 text-[13px] text-[#3f3f46]">
...
<x-accordion title="Saving" icon="save" color="slate">
