...
<x-layout.accordion title="Previews" icon="show" color="slate">
...
<x-layout.accordion title="Save as Done (Version Snapshot)" icon="cloud-upload" color="emerald">
    <div class="space-y-2 text-[13.5px] text-[#3f3f46]">
...
<x-layout.accordion title="Submission Gate" icon="check-shield" color="amber">
    <p class="text-[13.5px] text-[#3f3f46] mb-2">All of the following must be complete before you can submit:</p>
    <ul class="space-y-1.5 text-[13.5px] text-[#3f3f46]">
