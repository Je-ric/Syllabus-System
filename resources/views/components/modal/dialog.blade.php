...
@php
    ...
    │                                                                         │
    │  Variant aliases (aligned with modal.header):                           │
    │    default  → Emerald  │  add, assign, confirm, approve                 │
    │    delete   → Red      │  reject                                       │
    │    warning  → Yellow   │  archive, disable                             │
    │    info     → Blue     │  edit, roles, restore                         │
    └─────────────────────────────────────────────────────────────────────────┘
    */
    $group = match($variant) {
        'delete', 'reject'                        => 'delete',
        'warning', 'archive', 'disable'           => 'warning',
        'info', 'edit', 'roles', 'restore'        => 'info',
        default                                   => 'default',
    };
    $accentGradient = match($group) {
