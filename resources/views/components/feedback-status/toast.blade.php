...
@if($message)
    <div
        ...
        class="fixed inset-x-3 top-4 sm:inset-x-auto sm:right-5 z-[9999] w-auto sm:w-[28rem] max-w-[calc(100vw-1.5rem)] rounded-xl border p-3 shadow-xl backdrop-blur-sm {{ $toast['container'] }}"
        role="status"
        aria-live="polite"
    >
        <div class="flex items-start gap-3">
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm leading-5 break-words">{{ $message }}</p>
            </div>
