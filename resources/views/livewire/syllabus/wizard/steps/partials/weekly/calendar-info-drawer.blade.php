        ...
        <div class="rounded-[14px] border border-[#d1fae5] bg-[#f0fdf4] px-4 py-4 mb-4 flex items-center gap-3">
            ...
            <div class="min-w-0">
                ...
                @if ($cal->academic_year ?? null)
                    <p class="text-[11px] text-[#16a34a] font-bold uppercase tracking-[0.12em] mt-0.5">{{ $cal->academic_year }}</p>
                @endif
            </div>
        </div>
        ...
        @if ($weeksGenerated)
            ...
            <div class="grid grid-cols-3 gap-2 mb-5">
                <div class="rounded-[12px] border border-[#d1fae5] bg-[#f0fdf4] px-3 py-3 text-center">
                    ...
                    <p class="text-[10px] text-[#16a34a] font-bold uppercase tracking-[0.12em] mt-1">Weeks</p>
                </div>
                <div class="rounded-[12px] border border-[#e4e4e7] bg-[#fafafa] px-3 py-3 text-center">
                    ...
                    <p class="text-[10px] text-[#71717a] font-bold uppercase tracking-[0.12em] mt-1">Events</p>
                </div>
                <div class="rounded-[12px] border border-[#fde68a] bg-[#fffbeb] px-3 py-3 text-center">
                    ...
                    <p class="text-[10px] text-[#d97706] font-bold uppercase tracking-[0.12em] mt-1">Locked</p>
                </div>
            </div>
        @endif
            ...
            @if (count($typeEvents) > 0)
                ...
                <div class="mb-5">
                    <div class="flex items-center gap-2 mb-2.5">
                        ...
                        <p class="text-[11px] font-bold uppercase tracking-[0.12em] text-[#52525b]">{{ $meta['label'] }}</p>
