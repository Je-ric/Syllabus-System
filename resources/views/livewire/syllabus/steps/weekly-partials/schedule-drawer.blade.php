                ...
                <div class="rounded-xl border border-emerald-200 bg-emerald-50/40 overflow-hidden">
                    ...
                    <div class="px-4 py-3 space-y-1.5">
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-slate-500">Schedule</span>
                            <span class="text-sm font-medium text-slate-800">{{ $courseComponents['LEC']['schedule'] ?? '—' }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-slate-500">Class Hours</span>
                            <span class="text-sm font-mono text-slate-700">{{ $courseComponents['LEC']['class_hours'] ?? '—' }} hrs/wk</span>
                        </div>
                    </div>
                </div>
            @endif
            ...
            @if (!empty($courseComponents['LAB']))
                <div class="rounded-xl border border-blue-200 bg-blue-50/40 overflow-hidden">
                    ...
                    <div class="px-4 py-3 space-y-1.5">
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-slate-500">Schedule</span>
                            <span class="text-sm font-medium text-slate-800">{{ $courseComponents['LAB']['schedule'] ?? '—' }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-slate-500">Class Hours</span>
                            <span class="text-sm font-mono text-slate-700">{{ $courseComponents['LAB']['class_hours'] ?? '—' }} hrs/wk</span>
                        </div>
                    </div>
                </div>
            @endif
