    ...
    <div x-show="open" x-collapse>
        <div class="border-t border-slate-100">
            @if (count($programOutcomes) > 0)
                    ...
                    <table class="w-full text-xs border-collapse">
                        <thead>
                            <tr class="bg-slate-50 sticky top-0 z-10">
                                <th
                                    class="px-4 py-2.5 text-left text-[10px] font-bold
                                ...
                                <th
                                    class="px-4 py-2.5 text-center text-[10px] font-bold
                                            uppercase tracking-widest text-slate-400
                ...
                {{-- IED color legend --}}
                <div
                    class="px-4 py-2.5 bg-slate-50 border-t border-slate-100
