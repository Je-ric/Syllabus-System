...
<head>
    ...
    <title>429 — Too Many Requests | CSMS</title>
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body::before {
            ...
            inset: 0;
            background:
                radial-gradient(ellipse 80% 60% at 20% 10%, rgba(249,115,22,0.07) 0%, transparent 60%),
                radial-gradient(ellipse 60% 50% at 80% 85%, rgba(249,115,22,0.05) 0%, transparent 60%);
            pointer-events: none;
        }
        ...
        .accent-rail { height: 3px; background: linear-gradient(90deg, #F97316 0%, #EA6C0A 40%, rgba(249,115,22,0) 100%); }
        ...
        .icon-badge i { font-size: 2rem; color: #F97316; }
...
<body>
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <p>This is a <strong>rate limiting</strong> measure to protect system stability.</p>
        </div>
    </div>
