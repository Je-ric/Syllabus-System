    ...
    <x-modal.body>
        <div class="space-y-3">
            ...
            <div class="bg-gray-50 p-3 rounded border border-gray-200">
                <p class="font-semibold text-sm">Academic Year Details:</p>
            ...
            <p class="text-red-600 text-sm font-medium"><i class="bx bx-error"></i> This action cannot be undone and will delete all associated
                events.</p>
        </div>
    </x-modal.body>
