...
@section('content')
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                @elseif ($colleges->count() === 1)
                    <x-layout.card-section title="College" icon="bx-buildings">
                        <div class="relative">
                ...
                @if ($selectedCollegeId)
                    ...
                    @elseif ($departments->count() === 1)
                        <x-layout.card-section title="Department" icon="bx-sitemap">
                            <div class="relative">
                                <div class="w-full rounded-[14px] border border-[#e4e4e7] bg-[#f4f4f5] px-3 py-2 pr-9 text-[13px] text-[#a1a1aa] cursor-not-allowed truncate">
    ...
    @if ($selectedCollegeId && $selectedDepartmentId)
        @include('CQI.GoalObjective.modals.addObjectiveModal')
    @endif

    @foreach ($objectives as $objective)
        @include('CQI.GoalObjective.modals.updateObjectiveModal', ['objective' => $objective])
        @include('CQI.GoalObjective.modals.deleteObjectiveModal',  ['objective' => $objective])
    @endforeach
