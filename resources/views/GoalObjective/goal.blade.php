    ...
    <x-page-header
        ...
        @if ($selectedCollegeId)
            <button type="button"
                ...
                class="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold text-white transition"
                style="background: linear-gradient(90deg, #003a10 0%, #009639 100%);">
