                                ...
                                <thead class="bg-gray-100 border-b">
                                    <tr>
                                        ...
                                        @foreach ($program->outcomes as $outcome)
                                            <th class="px-2 py-2 text-center font-semibold text-xs">{{ $outcome->po_code }}
                                            </th>
                                        @endforeach
                                        ...
                                        <tr class="border-b hover:bg-gray-50">
                                            ...
                                            @foreach ($program->outcomes as $outcome)
                                                ...
                                                <td class="px-2 py-2 text-center font-medium">
                                                    <span
                                                        class="px-2 py-1 rounded text-xs {{ $ied === 'I' ? 'bg-blue-100 text-blue-700' : ($ied === 'E' ? 'bg-yellow-100 text-yellow-700' : ($ied === 'D' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500')) }}">
                                                        {{ $ied }}
                                                    </span>
                                                </td>
                                            @endforeach
