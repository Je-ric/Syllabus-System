...
<x-header-with-button
    title="{{ $pageTitle }}"
    description="Fill in the course details and map program outcomes below.">
                    ...
                    <x-table.table id="courseFormMapping" class="w-full table-fixed">
                        <x-table.head class="border-b border-slate-200">
                            <x-table.row>
                                ...
                                <x-table.th class="border-0 w-36 min-w-[9rem]">IED Level</x-table.th>
                            </x-table.row>
                        </x-table.head>
                        <x-table.body class="divide-y divide-slate-100">
                            @foreach ($programOutcomes as $outcome)
                                <x-table.row class="hover:bg-emerald-50/40 transition-colors">
                                    ...
                                    <x-table.td class="border-0 text-sm text-slate-700 leading-relaxed wrap-break-words max-w-[32rem]">
                                        {{ $outcome->po_text }}
                                    </x-table.td>
                                    <x-table.td class="border-0 w-36 min-w-[9rem] text-sm text-slate-700">
