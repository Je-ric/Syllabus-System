<x-modal.dialog id="confirmEditCourseModal" maxWidth="xl:max-w-xl lg:max-w-lg md:max-w-md sm:max-w-sm max-w-xs" width="w-full" maxHeight="max-h-[90vh]">
    <x-modal.header>
    ...
    <x-modal.body>
        <div class="flex flex-col items-center text-center gap-4">
            <div class="bg-blue-100 rounded-full w-12 h-12 flex items-center justify-center">
                <i class="bx bx-edit text-2xl text-blue-500"></i>
            </div>
            <h3 class="text-base sm:text-lg font-semibold text-blue-700">Ready to update this course?</h3>
            <p class="text-sm text-gray-600">Please review all course details and Program Outcomes IED levels before updating. This will overwrite the existing course data.</p>
